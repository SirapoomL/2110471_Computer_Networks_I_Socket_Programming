...
export function StickerSelector({ onSelect, show, className }: StickerSelectorProps) {
    return (
        <div className={`flex flex-row flex-wrap justify-evenly items-center p-2 w-full ${show? 'block': 'hidden'}` + ` ${className}`}>
